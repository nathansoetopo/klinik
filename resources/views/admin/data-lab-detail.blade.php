                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab2" data-toggle="tab" href="#menu1" role="tab"
                                    aria-controls="profile" aria-selected="false">LAB</a>
                            </li>
                        </ul>
                        <div class="tab-content tab-bordered" id="myTab3Content">
                            ...
                            <div id="menu1" class="tab-pane fade" style="background-color: white">
                                <form action="{{ url('admin/lab/'.$lab->id.'/update') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="container">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" id="diagnosa" name="diagnosis_klinis" placeholder="Masukkan Diagnosa"
                                                style="height: 100px">{{ $lab->diagnosis_klinis }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" id="infoTambahan"
                                                ...
                                                style="height: 100px">{{ $lab->info_tambahan }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="alergi">Nama Pemeriksaan</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="alergi"
                                                    name="nama_pemeriksaan" placeholder="Masukkan nama pemeriksaan" value="{{ $lab->nama_pemeriksaan }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6 p-3">
