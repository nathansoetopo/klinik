                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                                    ...
                                    <div class="container pt-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="gcs" id="gcs" class="form-control">
                                                @for ($i = 1; $i <= 15; $i++) <option value="{{ $i }}">GCS Level
                                                    {{ $i }}
                                                    </option>
                                                    @endfor
                                            </select>
                            ...
                            <div id="menu4" class="tab-pane fade" style="background-color: white">
                                <form action="{{ url('admin/lab') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" id="diagnosa" name="diagnosis_klinis"
                            ...
                            <div id="menu6" class="tab-pane fade" style="background-color: white">
                                <form action="{{ url('/admin/kontrol') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="container">
                                        <input type="hidden" name="pasien_id" value="{{ $pasienID }}">
                                        <label id="diagnosaKontrol">Diagnosa</label>
                                        <div class="form-group">
                                            <textarea class="form-control" name="diagnosis" id="diagnosaKontrol"
                                                style="height: 100px;"></textarea>
                                        </div>
                                        <label for="terapi">Tindakan/Terapi</label>
                                        <div class="form-group">
                                            <textarea class="form-control" name="tindakan" id="terapi"
                                                style="height: 100px;"></textarea>
                                        </div>
                                        <label for="alasanKontrol">Alasan Kontrol</label>
                                        <div class="form-group">
                                            <textarea class="form-control" id="alasanKontrol" name="alasan"
                                                style="height: 100px;"></textarea>
                                        </div>
                                        <label id="rtl">Rencana Tindak Lanjut</label>
                                        <div class="form-group">
                                            <textarea class="form-control col-12" id="rtl" name="rencana"
                                                style="height: 100px;"></textarea>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-5">
...
<script>
    var i = 0;
    var data = {!!json_encode($data_obat)!!}
    console.log(data)
    $(document).on('click', '#addForm', function () {
        ...
        var element = '<div class="container">' +
            '<label for="obat">Obat</label>' +
            '<div class="form-group">' +
            '<textarea class="form-control" id="obat" name="obat[' + i +
            '][obat]" placeholder="Masukkan Obat" style="height:100px;"></textarea>' +
            '</div>' +
            '<div class="form-row">' +
            '<div class="form-group col-md-7">' +
            '<label for="inputObat">Nama obat</label>' +
            '<select class="form-control" id="inputObat'+i+'" name="obat[' + i + '][select]">' +
        ...
        for(var d = 0; d < data.length; d++){
            $('#inputObat'+i).append('<option value="'+data[d][0]+'">'+data[d][1]+'</option>');
        }
    });
