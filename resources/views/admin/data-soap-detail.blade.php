                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                            ...
                            <div id="menu1" class="tab-pane fade" style="background-color: white">
                                <form action="{{ url('admin/soap/'.$soap->id.'/update') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="container pt-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="keluhan" id="keluhan" placeholder="Masukkan Keluhan"
                                                class="form-control" id="" style="height: 100px;">{{ $soap->keluhan }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="pemeriksaan_objective" id="pemeriksaan"
                                                ...
                                                style="height: 100px;">{{ $soap->pemeriksaan_objective }}</textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-4 col-lg-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="mmhg" name="tensi" value="{{ $soap->tensi }}">
                                            ...
                                            <div class="col-md-4 col-lg-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="nadi" name="nadi" value="{{ $soap->nadi }}">
                                                        <div class="input-group-prepend">
                                                            <div
                                                                class="input-group-text bg-secondary rounded text-white">
                                                                x/menit</div>
                                            ...
                                            <div class="col-md-4 col-lg-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="rr" name="rr" value="{{ $soap->rr }}">
                                                        <div class="input-group-prepend">
                                                            <div
                                                                class="input-group-text bg-secondary rounded text-white">
                                                                x/menit</div>
                                            ...
                                            <div class="col-md-4 col-lg-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="suhu" name="suhu" value="{{ $soap->suhu }}">
                                                        <div class="input-group-prepend">
                                                            <div
                                                                class="input-group-text bg-secondary rounded text-white">
                                                                °C
                                            ...
                                            <div class="col-md-4 col-lg-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="berat" name="berat" value="{{ $soap->berat }}">
                                                        <div class="input-group-prepend">
                                                            <div
                                                                class="input-group-text bg-secondary rounded text-white">
                                                                Kg
                                            ...
                                            <div class="col-md-4 col-lg-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="sp02" name="spo2" value="{{ $soap->spo2 }}">
                                                        <div class="input-group-prepend">
                                                            <div
                                                                class="input-group-text bg-secondary rounded text-white">
                                                                %
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control js-example-basic-multiple" name="tindakan"
                                                ...
                                                <option value="{{ $item }}" {{ $item === $soap->tindakan ? 'selected' : ''}}>{{ $item }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="text-tab mt-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="plan" id="plan" placeholder="Masukkan Plan"
                                                class="form-control" id="" style="height: 100px;">{{ $soap->plan }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="catatan">Catatan Dokter</label>
                                            <textarea name="catatan" id="gcs" placeholder="Masukkan Catatan Dokter"
                                                class="form-control" style="height: 100px;">{{ $soap->catatan }}</textarea>
                                        </div>
                                        <div class="text-tab mt-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="instruksi" id="instruksi" placeholder="Masukkan Instruksi"
                                                class="form-control" style="height: 100px;">{{ $soap->instruksi }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="evaluasi">Evaluasi</label>
                                            <textarea name="evaluasi" id="evaluasi" placeholder="Masukkan Evaluasi"
                                                class="form-control" style="height: 100px;">{{ $soap->evaluasi }}</textarea>
                                        </div>
                                        <div class="text-tab mt-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="statuspelayanan" name="status">
                                                ...
                                                <option id="Sudah Terlayani" value="{{ $item }}" {{ $item === $soap->status ? 'selected' : ''}}>{{ $item }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="row">
