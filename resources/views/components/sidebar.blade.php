    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            @if (auth()->user()->hasRole('admin'))
                ...
                <li><a class="nav-link @if (Request::is('admin/soap')) active @endif"
                        href="{{ url('/admin/soap') }}"><i class="fas fa-digital-tachograph"></i></i>
                        <span>SOAP</span></a>
                </li>
                <li><a class="nav-link @if (Request::is('admin/medicines')) active @endif"
                        href="{{ url('/admin/medicines') }}"><i class="fas fa-capsules"></i></i> <span>Data
                            Obat</span></a>
                </li>
                <li><a class="nav-link @if (Request::is('admin/lab')) active @endif"
                        href="{{ url('/admin/lab') }}"><i class="fas fa-flask"></i></i> <span>Diagnosis Lab</span></a>
                </li>
                <li><a class="nav-link @if (Request::is('admin/rad')) active @endif"
                        href="{{ url('/admin/rad') }}"><i class="fas fa-x-ray"></i></i> <span>Diagnosis Rad</span></a>
                </li>
            ...
            @elseif (auth()->user()->hasRole('kasir'))
                <li><a class="nav-link @if (Request::is('kasir')) active @endif" href="{{ url('kasir/') }}"><i
                            class="fas fa-columns"></i> <span>Dashboard</span></a></li>
            @endif
        </ul>
