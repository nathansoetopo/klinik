<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            <li><a class="nav-link @if(Request::is('admin')) active @endif" href="{{url('admin/')}}"><i class="fas fa-columns"></i> <span>Dashboard</span></a></li>
            ...
            <li><a class="nav-link @if(Request::is('admin/lab')) active @endif" href="{{ url('/admin/lab') }}"><i class="fas fa-flask"></i></i> <span>Diagnosis Lab</span></a>
            </li>
        </ul>
